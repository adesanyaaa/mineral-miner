...
/**
 * This class handles changes to the devices compass. It is exactly the same as
 * AccelerometerHandler except that it sets the sensor type to TYPE_ORIENTATION and has renamed member variables
 * @author jgillis
 *
 */
